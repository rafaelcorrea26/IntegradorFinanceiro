...
type
  ...
  public
    ...
    property pis_cofins: boolean read Fpis_cofins write Fpis_cofins;
    property consumidor_final: string read Fconsumidor_final write Fconsumidor_final;
    property indicador_presenca_comprador: string read Findicador_presenca_comprador
      write Findicador_presenca_comprador;
    ...
    property data_spc: String read Fdata_spc write Fdata_spc;
    ...
    property validade_vip: String read Fvalidade_vip write Fvalidade_vip;
    ...
    property data_cobranca: String read Fdata_cobranca write Fdata_cobranca;
    ...
    property nome_completo_nfe: string read Fnome_completo_nfe write Fnome_completo_nfe;
