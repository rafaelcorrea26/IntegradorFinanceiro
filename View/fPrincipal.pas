...
procedure TfrmPrincipal.appEventsMinimize(Sender: TObject);
begin
  EscondeTela;
end;
...
procedure TfrmPrincipal.ExibirTela;
begin
...
begin
  if Application.MessageBox(PChar('Deseja realmente fechar a aplicação?'), 'Encerramento do Sistema!',
